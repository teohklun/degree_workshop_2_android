...
public class SoundTest extends AppCompatActivity {
    ...
    private SoundTest.PlayerVisualizerView mVisualizerView;
...
//        mLinearLayout.setOrientation(LinearLayout.HORIZONTAL);
        ...
        mLinearLayout.addView(mStatusTextView, layoutParams);
...
//        setVolumeControlStream(AudioManager.STREAM_MUSIC);
    ...
    {
        mVisualizerView = new SoundTest.PlayerVisualizerView(this);
